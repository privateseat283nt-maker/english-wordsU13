...
const vocabulary = [
    ...
    { japanese: "秋（fからはじまる）", english: "fall" },
    ...
    { japanese: "１日（ついたち）", english: "first" },
    ...
    { japanese: "～から、～より（起点）", english: "from" },
    ...
    { japanese: "～へ、～に、～すること、～するために（方向・到達点を示す）", english: "to" },
    ...
    { japanese: "～の下に、～のもとに、〜未満、〜の管理下、〜の支配下、〜の状態で、（何かに）覆われて", english: "under" },
    ...
    { japanese: "～と一緒に、～を使って、～を持ちながら、～（原因）で、～（感情）に対して（手段・道具・付帯状況・感情・原因）", english: "with" },
    { japanese: "女性", english: "woman" },
    { japanese: "仕事，作品", english: "work" },
    { japanese: "書く，手紙を書く", english: "write" },
    { japanese: "中庭、校庭、作業場、置き場", english: "yard" },
